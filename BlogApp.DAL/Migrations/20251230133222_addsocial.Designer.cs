...
namespace BlogApp.DAL.Migrations
{
    ...
    [Migration("20251230133222_addsocial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApp.Core.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        ...
                        .HasDefaultValue(new DateTime(2025, 12, 30, 17, 32, 21, 649, DateTimeKind.Local).AddTicks(1702));
            ...
            modelBuilder.Entity("BlogApp.Core.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 12, 30, 17, 32, 21, 649, DateTimeKind.Local).AddTicks(4619));
            ...
            modelBuilder.Entity("BlogApp.Core.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApp.Core.Entities.Story", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApp.Core.Entities.Message", b =>
                {
                    b.HasOne("BlogApp.Core.Entities.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogApp.Core.Entities.AppUser", "Sender")
                        .WithMany()
